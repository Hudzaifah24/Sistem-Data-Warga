...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <a href="{{ route('desa.create') }}" class="my-3 btn btn-info">TAMBAH DATA</a>
        </div>
        <!-- /.container-fluid -->
        </section>
                ...
                <table class="table table-striped Data Warga">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right w-75">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($desa as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="" class="text-light" data-toggle="tooltip" data-placement="top" title="KTP">{{ $data->desa }}</a>
                                    <br />
                                    <small> Created {{ $data->created_at }} </small>
                                </td>
                                <td class="text-right project-actions">
                                    <a class="btn btn-primary btn-sm" href="{{ route('desa.show', $data->id) }}">
                                        <i class="fas fa-folder"> </i>
                                        View
                                    </a>
                                    <a class="btn btn-info btn-sm" href="{{ route('desa.edit', $data->id) }}">
                                        <i class="fas fa-pencil-alt"> </i>
                                        Edit
                                    </a>
                                    <form action="{{ route('desa.destroy', $data->id) }}" method="POST" class="">
                                        @csrf
                                        @method('DELETE')
